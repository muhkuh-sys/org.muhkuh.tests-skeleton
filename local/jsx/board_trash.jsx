class Interaction extends React.Component {
  ...
  render() {
    return (
      <div>
        <div style={{width: '100%'}}>
            <Typography align="center" variant="h3" gutterBottom>Board defekt</Typography>
            <Typography align="center" variant="subtitle1" gutterBottom>Das ist für die Tonne. Klebe ein "Gesperrt" Aufkleber drauf.</Typography>
        </div>
